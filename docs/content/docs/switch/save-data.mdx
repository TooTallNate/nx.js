...
// Write to filesystem - be sure to `commit()` changes after a write!
...
> installed and homebrew applications.

## Learn more

<Cards>
  <Card title="Learn more about user profile selection" href="/docs/profiles" />
  <Card title="Learn more about the `Switch.Application` class" href="/docs/applications" />
</Cards>