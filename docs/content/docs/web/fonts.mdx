...
[`FontFace`](https://developer.mozilla.org/docs/Web/API/FontFace) class,
by providing the name of the font and the font data.
...
[`FontFaceSet`](https://developer.mozilla.org/docs/Web/API/FontFaceSet) registry.
The global `fonts` is available for this purpose, similar to how you would
register a font in a "web worker" context.
