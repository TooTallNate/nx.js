...
<Screenshot src={SystemUiScreenshot} alt="Text rendered using the system-ui font" />
...
<Screenshot src={SystemIconsScreenshot} alt="System icon glyph rendered using the system-icons font" />
...
<Screenshot src={CustomFontsScreenshot} alt="Text rendered using custom Clear Sans font in regular and bold weights" />
