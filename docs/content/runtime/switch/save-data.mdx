...
<Cards>
  <Card title="Learn more about user profile selection" href="/runtime/switch/profiles" />
  <Card title="Learn more about the `Switch.Application` class" href="/runtime/switch/applications" />
</Cards>
