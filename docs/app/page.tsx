	...
	return (
		<main className='flex h-screen flex-col justify-center items-center text-center gap-6'>
			...
			<div className='flex text-5xl gap-8'>
				<a href="https://github.com/TooTallNate/nx.js" target="_blank" title="GitHub Repository">
					<GitHub className='fill-white hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)] transition-all' />
				</a>
				<a href="https://discord.gg/MMmn73nsGz" target="_blank" title="Discord Server">
					<Discord className='fill-white hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.4)] transition-all' />
				</a>
				<a href="https://gbatemp.net/threads/nx-js-javascript-runtime-for-nintendo-switch-homebrew-applications.639171/" target="_blank" title="GBATemp Thread">
