...
LIBS	:=  -pthread -lmbedtls -lmbedx509 -lmbedcrypto -lharfbuzz `freetype-config --libs` `aarch64-none-elf-pkg-config cairo --libs` -lturbojpeg -lEGL -lGLESv2 -lglapi -ldrm_nouveau -lnx -lwebp -lqjs -lm3 -lm
