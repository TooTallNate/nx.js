...
static JSValue nx_battery_init(JSContext *ctx, JSValueConst this_val, int argc,
							   JSValueConst *argv) {
...
static JSValue nx_battery_exit(JSContext *ctx, JSValueConst this_val, int argc,
							   JSValueConst *argv) {
	psmExit();
	return JS_UNDEFINED;
}

static JSValue nx_battery_charging(JSContext *ctx, JSValueConst this_val,
...
static JSValue nx_battery_level(JSContext *ctx, JSValueConst this_val, int argc,
								JSValueConst *argv) {
	double rawCharge;
...
static JSValue nx_battery_init_class(JSContext *ctx, JSValueConst this_val,
									 int argc, JSValueConst *argv) {
	JSAtom atom;
